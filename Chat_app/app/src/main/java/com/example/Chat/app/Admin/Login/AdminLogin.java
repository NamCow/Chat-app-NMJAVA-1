...
public class AdminLogin extends javax.swing.JFrame {
        ...
        private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
                // TODO add your handling code here:
                AdminSignup SignupFrame = new AdminSignup();
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                ...
                if (userID != null) {
                    if (userID.equals("Account is locked")) {
                        ...
                        String role = null;
                        try (
                            PreparedStatement roleStmt = conn != null ? conn.prepareStatement(
                                    "SELECT role FROM users WHERE user_id = ?") : null
                        ) {
                            if (roleStmt != null) {
                                roleStmt.setInt(1, Integer.parseInt(userID));
                            ...
                            e.printStackTrace();
                            JOptionPane.showMessageDialog(null, "Error checking user role: " + e.getMessage(), "Error",
                                    JOptionPane.ERROR_MESSAGE);
                            return;
                        }
            
                        if ("admin".equalsIgnoreCase(role)) {
                            // Log successful login into login_history table and update status to 'active'
                            try (
                            ...
                            JOptionPane.showMessageDialog(null, "Login as Admin successful", "Success", JOptionPane.INFORMATION_MESSAGE);
                            java.awt.EventQueue.invokeLater(new Runnable() {
                                public void run() {
                                    ...
                                    adminUI.addWindowListener(new java.awt.event.WindowAdapter() {
                                        @Override
                            ...
                            JOptionPane.showMessageDialog(null, "Access denied. Admin role is required.", "Error",
                                    JOptionPane.ERROR_MESSAGE);
                        }
                    }
                } else {
